...
date: 2026-04-09
episode_number: 268
custom_youtube_embed_url: https://youtu.be/QBbNevwcM5Y
---
...
<div style={{ display: "flex", justifyContent: 'space-around', alignItems: 'center', flexWrap: "wrap", maxWidth: '100%'  }}>
    <GuestCallout name="Jaikumar Ganesh" link="https://www.linkedin.com/in/jaikumarganesh/" image={GuestImage} brandImg={BrandImage} />
</div>

We sit down with Jaikumar Ganesh, Head of Engineering at [AnyScale](https://www.linkedin.com/company/joinanyscale/), to explore the intricacies of heterogeneous compute. He unpacks the growing CPU/GPU divide, detailing how ML pipelines require precise orchestration — using CPUs for data reading and writing while leveraging expensive, massive-die GPUs for chunking and embedding.
...
* JK - [Book: The Explorer's Gene](https://amzn.to/4cD6O15)